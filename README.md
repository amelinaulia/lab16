...
## Условие задачи
Вариант 22. Массив d0, d1, d2, ..., dh из элементов массивов а0, а1, а2, ..., an, b0, b1, b2 ..., bn, с0, с1,с2, ..., сn расположенные до последнего отрицательного элемента, в обратном порядке.
...
![Блок схема алгоритма](poto5.bmp)
